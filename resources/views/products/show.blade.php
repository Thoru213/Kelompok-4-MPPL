        ...
        <div class="md:w-1/2 flex flex-col justify-between">
            <div>
                ...
                <div class="flex items-center text-gray-700 text-xl mb-6">
                    <span class="font-semibold mr-3">Stok Tersedia:</span> {{ $product->stock }} unit
                </div>
            </div>
            <button class="bg-blue-600 text-white px-10 py-5 rounded-full text-xl font-bold hover:bg-blue-700 transition duration-300 w-full shadow-lg transform hover:scale-105">
                Tambah ke Keranjang
            </button>
        </div>
    </div>
